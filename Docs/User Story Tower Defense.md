...
| US | 1,7 | Défenseur Lancer une nouvelle vague manuellement avec un "Skip" |
| US | 1,8 | Défenseur Eliminer des ennemis |
| US | 1,9 | Défenseur Perdre des points de vie |
| US | 1,10 | Défenseur Revendre des tours |
| US | 1,11 | Défenseur Monter en niveau |
| US | 1,12 | Défenseur Choisir la cible à attaquer |
| US | 1,13 | Défenseur Affronter différents types d'ennemis |
...
| Prendre le temps de placer mes tours ou accélérer la vague suivante | Should |
